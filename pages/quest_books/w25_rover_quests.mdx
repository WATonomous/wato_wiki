...
1. **Point Cloud Generator**:
    - Create a point cloud using the IntelRealSense D435 cameras, and publish that to Nav2 for Costmap Generation, and localization.
2. **Object Detection**:
...
**Minimum Requirements:**  Partially integrated with basic functionality for a score above 7/10.
...
| 7/10  | Rover is able to accurately detect but not publish goal pose for Object. |
| 4/10  | Rover is able to inaccurately/unreliably detect Object but not publish goal pose. |
| 0/10  | No progress.                                                            |

**Minimum Requirements:** Rover is able to inaccurately/unreliably detect Object but not publish goal pose for a score above 4/10.
...
| 7/10  | Rover is able to accurately detect but not publish goal pose for ArUco marker. |
| 4/10  | Rover is able to inaccurately/unreliably detect ArUco marker but not publish goal pose. |
| 0/10  | No progress.                                                            |

**Minimum Requirements:** Rover is able to inaccurately/unreliably detect ArUco marker but not publish goal pose for a score above 4/10.

...
| Score | Criteria                                                                 |
|-------|-------------------------------------------------------------------------|
| 10/10 | Constructed Ring Road Lanelet2 map with lane connectivity, traffic lights, stop signs, and other regulatory elements. |
| 4/10  | Automatically construct a valid Lanelet2 map from recorded sensor data, including lane boundaries and lanelets. |
| 1/10  | Basic ring road HD map loading and visualization (manually drawn). |

**Minimum Requirements:** Automatically construct a valid Lanelet2 map from recorded sensor data, including lane boundaries and lanelets. 4/10.

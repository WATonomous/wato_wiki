...
|------------|-------------|----------|-------|
| Hardware Setup | Setup everything including Jetson, LiDAR and VESC to work properly and publish ros messages needed for autonomous navigation | 2025-08-31 | 10/10 |
| State Estimation | Estimates current position of vehicle relative to last position using Kalman Filter. | 2025-08-31 | 9/10 |

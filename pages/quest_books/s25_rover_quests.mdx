...
The WATO Rover Team is helping build the autonomous navigation system for the UWRT's [URC 2026](https://urc.marssociety.org/home/requirements-guidelines) rover. 
...
1. **Convert depth camera data into a costmap.**
1. **Complete localization using GPS/IMU and odometry and test on the rover.** 
1. **Compute and publish goal pose of detected object.**
1. **Navigate autonomously to chosen point.**
...
3. **Localization using GPS/IMU and odometry and testing on the rover.** 
...
| Score | Criteria                                                                 |
|-------|-------------------------------------------------------------------------|
| 10/10 | Rover is able to accurately compute the pose of detected object (e.g. mallet or water bottle) and publish it to the correct topic. |
...
| Costmap Generation | Convert depth camera data into a costmap for navigation using Nav2. |May 30|  | 
...
| Autonomous Navigation | Navigate the rover autonomously and efficiently to a chosen point using the generated costmap. |June 27| |
| Blog Posts | Write at least three blogs on simulating the rover in autonomy software and lessons learned. |August 14| |

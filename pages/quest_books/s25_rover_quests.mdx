...
The objectives for Spring 2025 focus on building upon [Winter 2025](https://wiki.watonomous.ca/quest_books/archive/w25_rover_quests/) progress and completing essential autonomous navigation functionality.

1. **Simulate collecting depth camera data from three different cameras.**
2. **Convert depth camera data into a costmap.**
2. **Compute and publish goal pose of detected object.**
...
3. **Compute and publish goal pose of detected object**
...
| 0/10  | Rover is unable to do any pose computation for the objects |

**Minimum Requirements:** Rover is able to compute and publish an approximate pose for a score above 7/10.


4. **Autonomously navigate to chosen point**
...
| Goal Pose Generation | Compute and publish goal poses of detected objects we need to navigate to. |  |  | 

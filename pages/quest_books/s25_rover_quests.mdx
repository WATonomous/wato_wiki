# Rover Quest Book - Fall 2025 (S25)

## The Great Objective: Complete the autonomous navigation stack for the UW Mars Rover.
...
The objectives for Fall 2025 are centered on 
...
|--------------------------------------------|------------------------------------------------------------------------------------------------------|-------------|--------| 
| Depth Camera Simulation | Simulate collecting depth camera data from three different cameras and publish to Nav2. |May 30 |  | 

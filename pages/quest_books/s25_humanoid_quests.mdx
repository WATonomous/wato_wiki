...
These are the objectives for the Spring/Summer 2025 term.

# Software# Humanoid Quest Book
...
| --- | --- |
| +4 | Object detection |
| +4 | Keyboard specific objected detection |
| +4 | Material Classification |
| +4 | Publishing filtered RGBD data  |

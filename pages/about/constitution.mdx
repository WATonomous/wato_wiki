...
Let me know if you'd like to break this into bullet-heavy sections or visualize it in a table for onboarding docs.
...
- **Squad Leads** are responsible for:
  - Breaking down Quests into actionable tasks within their squad.
  - Tracking progress and removing blockers.
  - Leading the scoring discussion related to their squad’s work.
...
2. **Leadership** – Who will guide the organization through this period.
...
Let me know if you'd like to include examples or scenarios to help members better understand how this clause would be applied in practice.

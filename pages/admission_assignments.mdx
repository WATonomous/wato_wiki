...
import { BrainCircuit, Bot, Wrench, Cpu } from 'lucide-react'

<Cards num={3}>
    <Card icon={<BrainCircuit />} title="Autonomous Software Assignment" href="/admission_assignments/asd_admission_assignment" />
    <Card icon={<Wrench />} title="Humanoid Hardware Assignment" href="/admission_assignments/humanoid_hardware_admission_assignment" />
    <Card icon={<Cpu />} title="Humanoid Electrical Assignment" href="/admission_assignments/humanoid_electrical_admission_assignment" />

...
Started in summer 2017, WATonomous is the University of Waterloo's first student-run autonomous car team. We are an agile group of developers, engineers, businessmen looking to lead the next generation of robotic systems and their applications. Ultimately, we just want to prove that you don't need a room full of current FAANG employees to build a self driving car! All you need for a self driving car is a self driven individual ;)

...
<Callout type="warning" emoji="⚠️">
  If you are using Windows, we recommend setting up dual boot on your computer or using a MacBook. Windows is not a developer-friendly environment. That being said, here are some tips if you are trying to rough your way through Windows:
  plz add more here
</Callout>
